...
(function(global, factory) {
	...
	/**
	 * Remove an item from an array、删掉查找的对象
	 */
	...
	/**
	 * Check whether the object has the property.检查当前对象具备当前属性
	 */
	var hasOwnProperty = Object.prototype.hasOwnProperty;//当前原型属性
	...
	/**
	 * Camelize a hyphen-delimited string.当前为字符串的时候取代全部字符串，为方法和正则表达式
	 */
	var camelizeRE = /-(\w)/g;
	 ...
	 * if they are plain objects, do they have the same shape?判断2个是否相同
	 */
...

	{
		...
		warn = function(msg, vm) {
			var trace = vm ? generateComponentTrace(vm) : '';//格式组成名字
